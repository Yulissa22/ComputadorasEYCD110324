...
{
    public partial class ComputadorasEYCD110324DbContext : DbContext
    {
        public ComputadorasEYCD110324DbContext()
        {
        }

        public ComputadorasEYCD110324DbContext(DbContextOptions<ComputadorasEYCD110324DbContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=ComputadorasEYCD110324Db;Integrated Security=True;Encrypt=False");
//            }
        }
